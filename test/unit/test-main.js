...
require.config({
    ...
    shim: {
        ...
        'ng-jedi-i18n': ['angular'],
        'ng-jedi-dialogs': ['angular'],
        'ng-jedi-factory': ['angular'],
        'ng-jedi-loading': ['angular'],  
        'ng-jedi-breadcrumb': ['angular'],  
        'ng-jedi-layout': ['angular'],  
        'ng-jedi-utilities': ['angular'], 
