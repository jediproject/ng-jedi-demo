...
require.config({
    ...
    paths: {
        ...
        'angular-file-upload': 'assets/libs/angular-file-upload-interceptor/angular-file-upload-interceptor.js',
        ...
        'angular-ngMask': 'assets/libs/angular-ngMask-alias/ngMask.js',
